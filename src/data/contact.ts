...
const Contact = {
    ...
    [LANGs.MYANMAR]: {
        title: "ဆက်သွယ်ရန်",
        description:
            "သင့်ရဲ့ လည်ပတ်မှုအတွက် ဝမ်းသာမိပါတယ်။ မေးခွန်းများ၊ အကြံဉာဏ်များရှိရင်၊ ဒါမှမဟုတ် ဆက်သွယ်ချင်ရင် အချိန်မရွေးဆက်သွယ်လိုက်ပါ။ အမြန်ဆုံးပြန်လည်ဆက်သွယ်ပေးပါမယ်။",
    },
};
